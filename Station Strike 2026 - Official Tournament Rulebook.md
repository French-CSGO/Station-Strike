...
The Station Strike tournament is organized by FragAdmin (Nono & Iwhite), a French esports organization.
...
Teams must register at [https://github.com/French-CSGO/Station-Strike](https://github.com/French-CSGO/Station-Strike).
...
Teams register on the official website. Payment of **€250 VAT included** per team (covering 5 players) confirms the reservation of the slot. After payment, the team representative will receive the registration form via the official Station Strike Discord server, which must be completed to confirm participation.
...
Teams must check in at the venue on Day 1 before the designated time (the exact schedule will be communicated and available at [https://github.com/French-CSGO/Station-Strike](https://github.com/French-CSGO/Station-Strike)). All team members must be on-site and ready at least one hour before their first match. Any team that fails to check in on time may be disqualified.
...
Station Strike 2026 takes place over five days, with a Swiss Round group stage and a double-elimination playoffs bracket. With 32 teams registered at the deadline, the format is structured as follows:
