# Station Strike 2026 – Official Tournament Rulebook

---

### Event Overview

The Station Strike tournament is organized by FragAdmin (Iwhite), a French esports organization and Station 35, a french Cybercafe.

Station Strike is a Counter-Strike 2 Tier 2 tournament ranked in the Valve Regional Standings (VRS), offered in an open LAN format. This event provides a competitive on-site experience in France and is open to any team ready to compete.

As a VRS-ranked event, Station Strike adheres to Valve's regulations for ranked tournaments, ensuring a fair structure for seedings and qualifications. The Valve Regional Standings (VRS) is the official ranking system used by Valve to evaluate team performance and determine invitations to CS2 events.

This rulebook details all rules, format, and expectations for teams participating in Station Strike.

### Event Information

**Event Name:** Station Strike 2026 – Counter-Strike 2
...
**Venue:** Station 35, 31 rue Xavier Grall, 35700 Rennes, France

### Maximum Capacity

The maximum number of participants is set at **24 teams**. Registrations are open to all teams on a first-come, first-served basis.
...
| Pack | Includes | Price (excl. VAT) |
|------|----------|-------------------|
| **Pack A** — Slot NO BYOC | Entry slot for 1 team (5 players) | **€1,000.00** |
| **Pack B** — Slot + Hotel + Transport | Entry slot + Hotel (5 nights, 3 double rooms + breakfast) + Round-trip transport (station/airport ↔ hotel) | **€2,500.00** |
| **Pack C** — Slot + Hotel + Transport + Catering | Entry slot + Hotel (5 nights, 3 double rooms + breakfast) + Round-trip transport (station/airport ↔ hotel) + Catering (2 meals/day for 5 days for 6 players + drinks) | **€3,500.00** |
...
5. **Wait for confirmation** — teams are accepted in order of payment proof received.
...
In accordance with Valve's guidelines for Tier 2 events, **Station Strike 2026** will use VRS rankings to seed teams into the main event once registrations close (approximately one week before the event).
...
Teams must check in at the venue on Day 1 before the designated time (the exact schedule will be communicated and available at [http://www.StationStrike.gg](https://StationStrike.gg)). All team members must be on-site and ready at least one hour before their first match. Any team that fails to check in on time may be disqualified.
...
Station Strike 2026 takes place over five days, featuring a GSL-style group stage and a direct seeding system for top-ranked teams. With 24 teams registered at the deadline, the format is structured as follows:

**Days 1–2 – Group Stage:**
16 teams compete in 4 GSL groups of 4 teams each. The top 2 teams from each group advance to the Playoffs.

**Days 3–5 – Playoffs:**
A 16-team Single-elimination bracket combines the 8 teams advancing from the Group Stage with the 8 highest VRS-ranked teams seeded directly into the Round of 16.
...
### Participants
16 teams — all registered teams except the 8 highest VRS-ranked teams, who are seeded directly into the Playoffs.

### Seeding
Teams are seeded according to the organizer's evaluation (VRS ranking, HLTV ranking, Faceit Elo, competitive results) and divided into 4 pots of 4:
...
### Qualification
The **top 2 teams from each group** (8 teams total) advance to the Playoffs.

### Group Stage Schedule
Group Stage matches will be organized in waves across available stations to ensure all matches are completed within Days 1 and 2.
...
The Group Stage is expected to conclude at the end of Day 2, after which qualifying teams will be notified for Playoffs.
...
### Participants
16 teams in total:
- **8 teams** seeded directly (the 8 highest VRS-ranked registered teams)
- **8 teams** qualified from the Group Stage (top 2 from each of the 4 GSL groups)

### Seeding

| Seeds | Teams |
|-------|-------|
| 1–8 | Directly seeded teams, ordered by VRS ranking |
| 9–12 | Group Stage winners, ordered by VRS ranking / initial seeding criteria |
| 13–16 | Group Stage runners-up, ordered by VRS ranking / initial seeding criteria |

### Bracket Format
Single Elimination Bracket — teams are eliminated only after one losses.

### Match Format

| Round | Format |
|-------|--------|
| Upper Bracket Round of 16 (Matches 1–8) | Best-of-1 |
| All subsequent Upper Bracket matches | Best-of-3 |
| All Lower Bracket matches | Best-of-1 |
...
### Provided Equipment
The venue will provide fully equipped gaming stations for all participants. Each player will have access to the following setup:
...
### Config Management
Each player must provide their personal CS2 config on a **USB drive** prior to the event. USB drives will be collected by admins at check-in and held securely throughout the tournament. In exchange, each player must hand over their **mobile phone** to the admins for the duration of the match, which will be returned immediately after the match ends.

### Setup Time
At the start of each match, players will have a maximum of **15 minutes** to set up their peripherals, load their config from the USB drive, and configure their in-game settings. Once setup is complete, teams have a maximum of **15 additional minutes** to go live. If a team is not ready to start within this window, admins may apply punctuality penalties as outlined in the Match Schedule & Punctuality section.
...
### Recording Devices
As stated above, players must hand over their mobile phones to admins before each match starts. No other recording or communication devices (smartwatches, tablets, etc.) are permitted in the competition area during an active match. These must be left in a secure location during play. The only permitted communication is via the in-game or approved voice channel with teammates and the coach.
...
The Station Strike 2026 tournament prize pool is funded by the organizer.
...
Prize money will be awarded and paid in accordance with applicable law and will be subject to all applicable taxes. The Organizer will only process payments after verifying the eligibility of winning teams and collecting all necessary documents, such as invoices, bank details, and identification. Any tax obligations arising from winnings are the responsibility of the recipients.
...
In the unlikely event that **Station Strike 2026** is postponed or cancelled due to unforeseen circumstances (including but not limited to natural disasters, venue failure, national emergencies, or health crises), organizers will offer teams the option of a full refund or transfer of registration to the rescheduled date, where applicable.
...
**IMPORTANT:**
The event organizers reserve the right to modify or amend this rulebook at any time. All changes will be publicly posted with updates to this document and will be made available to all participants via StationStrike.gg and the official Station Strike Discord server.
...
Let's make this a memorable event for everyone: players, viewers, and staff alike. Good luck and have fun to all teams, and welcome to **Station Strike 2026**.
